namespace :db do
  ...
  task populate: :environment do
    ...
    Program.create!(name: "Maestría en Arquitectura de Tecnologías de Información", code:"SNIES 101531", objetives:"Las tecnologías de información (TI) se han convertido en el motor de las organizaciones, apoyando tanto su operación como la toma estratégica de decisiones de negocio", status:"Activo")
    Program.create!(name: "Maestría en Ingeniería de Sistemas y Computación", code:"SNIES 1579", objetives:"Conscientes de la evolución de la informática y su rol e impacto en el mundo actual, el Departamento de Ingeniería de Sistemas y Computación presenta un programa de Maestría alrededor de temáticas de punta como Computación Visual, Cloud Computing, Big Data, Gestión de Conocimiento y Computación Móvil.", status:"Activo")
    Program.create!(name: "Maestría en Ingeniería de Software", code:"SNIES 102073", objetives:"A nivel mundial, la industria de software es crítica para el crecimiento económico y la innovación", status:"Activo")
    Program.create!(name: "Maestría en Seguridad de la Información", code:"SNIES 102074", objetives:"La sociedad depende del manejo apropiado de la información y de las tecnologías y herramientas que permiten acceder a ella", status:"Activo")
    Program.create!(name: "Maestría en Tecnologías de Información para el Negocio", code:"SNIES 102269", objetives:"En los últimos años, las Tecnologías de Información (TI) han desbordado su papel tradicional de servir de soporte para las labores administrativas y operativas de la empresa, y se han convertido en un elemento crucial para la competitividad, el crecimiento y la internacionalización", status:"Activo")
